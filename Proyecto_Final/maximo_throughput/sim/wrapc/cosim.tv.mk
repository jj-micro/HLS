...
$(ObjDir)/matrixcalc_test.cpp_pre.cpp.tb.o : matrixcalc_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling matrixcalc_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/matrixcalc.cpp_pre.cpp.tb.o : matrixcalc.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling matrixcalc.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
