...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matrixcalc.autotvin.dat"
	set constFileTvOut       "matrixcalc.autotvout.dat"
	set constFileHdlTvIn     "matrixcalc.autohdltvin.dat"
	set constFileHdlTvOut    "matrixcalc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
