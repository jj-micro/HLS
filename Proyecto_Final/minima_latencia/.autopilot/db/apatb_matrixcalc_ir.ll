; ModuleID = 'C:/Users/aulavirtual/Desktop/Trabajo_Final/Proyecto_Final/prueba_1/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a3a3struct.ap_int<4>.14.17"([3 x [3 x %"struct.ap_int<4>"]]* "orig.arg.no"="0" %dst, %"struct.ap_int<4>"* readonly "orig.arg.no"="1" "unpacked"="1.0.0" %src_0_0, %"struct.ap_int<4>"* readonly "orig.arg.no"="1" "unpacked"="1.0.1" %src_0_1, %"struct.ap_int<4>"* readonly "orig.arg.no"="1" "unpacked"="1.0.2" %src_0_2, %"struct.ap_int<4>"* readonly "orig.arg.no"="1" "unpacked"="1.1.0" %src_1_0, %"struct.ap_int<4>"* readonly "orig.arg.no"="1" "unpacked"="1.1.1" %src_1_1, %"struct.ap_int<4>"* readonly "orig.arg.no"="1" "unpacked"="1.1.2" %src_1_2, %"struct.ap_int<4>"* readonly "orig.arg.no"="1" "unpacked"="1.2.0" %src_2_0, %"struct.ap_int<4>"* readonly "orig.arg.no"="1" "unpacked"="1.2.1" %src_2_1, %"struct.ap_int<4>"* readonly "orig.arg.no"="1" "unpacked"="1.2.2" %src_2_2, i64 "orig.arg.no"="2" %num) #1 {
entry:
  %0 = icmp eq %"struct.ap_int<4>"* %src_0_0, null
  %1 = icmp eq [3 x [3 x %"struct.ap_int<4>"]]* %dst, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
src.addr.case.0:                                  ; preds = %for.loop
  call void @"arraycpy_hls.p0a3struct.ap_int<4>.15.16"([3 x %"struct.ap_int<4>"]* %dst.addr, %"struct.ap_int<4>"* %src_0_0, %"struct.ap_int<4>"* %src_0_1, %"struct.ap_int<4>"* %src_0_2, i64 3)
  br label %src.addr.exit

src.addr.case.1:                                  ; preds = %for.loop
  call void @"arraycpy_hls.p0a3struct.ap_int<4>.15.16"([3 x %"struct.ap_int<4>"]* %dst.addr, %"struct.ap_int<4>"* %src_1_0, %"struct.ap_int<4>"* %src_1_1, %"struct.ap_int<4>"* %src_1_2, i64 3)
  br label %src.addr.exit

src.addr.case.2:                                  ; preds = %for.loop
  %4 = icmp eq i2 %3, -2
  call void @llvm.assume(i1 %4)
  call void @"arraycpy_hls.p0a3struct.ap_int<4>.15.16"([3 x %"struct.ap_int<4>"]* %dst.addr, %"struct.ap_int<4>"* %src_2_0, %"struct.ap_int<4>"* %src_2_1, %"struct.ap_int<4>"* %src_2_2, i64 3)
  br label %src.addr.exit
