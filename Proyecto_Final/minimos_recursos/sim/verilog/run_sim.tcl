...
if {[file isfile matrixcalc.autotvin.dat]} {
	file delete -force matrixcalc.autotvin.dat
}

if {[file isfile matrixcalc.autotvout.dat]} {
	file delete -force matrixcalc.autotvout.dat
}
