...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matrixcalc_aux_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename a \
    op interface \
    ports { a_address0 { O 4 vector } a_ce0 { O 1 bit } a_q0 { I 4 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename b \
    op interface \
    ports { b_address0 { O 4 vector } b_ce0 { O 1 bit } b_q0 { I 4 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename c \
    op interface \
    ports { c_address0 { O 4 vector } c_ce0 { O 1 bit } c_q0 { I 4 vector } } \
} "
} else {
