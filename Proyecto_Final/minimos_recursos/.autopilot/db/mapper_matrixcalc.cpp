...
using hls::sim::Byte;
extern "C" int matrixcalc(Byte<1>*, Byte<1>*, Byte<1>*);
extern "C" int apatb_matrixcalc_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c) {
...
__xlx_c__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_c)[i]);
  ...
  int __xlx_size_param_c = 9;
  int __xlx_offset_param_c = 0;
  int __xlx_offset_byte_param_c = 0*1;
  // DUT call
  int ap_return = matrixcalc(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_c__tmp_vec.data());
