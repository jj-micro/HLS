...
set ip_vlnv xilinx.com:hls:matrixcalc:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project Proyecto_Final
dict set report_options hls_solution minimos_recursos
...
dict set report_options bindmodules {matrixcalc_mul_4s_4s_4_1_1 matrixcalc_aux_RAM_AUTO_1R1W}
